...
function renderPricingFilters() {
  const options = [
    ...
    { id: "booster", label: "booster",icon: "boost" },
  ];
  ...
  modal.innerHTML = `
    <div class="modal-body" style="padding-top: 24px;">
      ...
      <div class="modal-section">
        ...
        <div class="modal-desc">
          the FiveM market is filled with overpriced scripts hiding backdoors and broken code.

We fix them, clean them, and release them for free—no paywalls, no scams.

Simple: make FiveM open for everyone.
        </div>
      </div>
